...
We will test the hosted version for accuracy and the accuracy must be up to standards. UI and UX must be good. Pay attention to good design and aesthetics, it can compensate for some inaccuracies in output
